...
public class HadoopJob {
  ...
  public enum JobState {
    PREPARE(JobStatusState.PREP), RUNNING(JobStatusState.RUNNING), FAILED(JobStatusState.FAILED), SUCCEEDED(JobStatusState.SUCCEEDED);
    ...
    static JobState ofInt(int state) {
      switch (state) {
        case JobStatusState.PREP:
          return PREPARE;
        case JobStatusState.RUNNING:
          return RUNNING;
        case JobStatusState.FAILED:
          return FAILED;
        case JobStatusState.SUCCEEDED:
          return SUCCEEDED;
        default:
          return null;
      }
